...
const Repository: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // requisição das issues só é executada apos a requisicao de repository
    //   const repository = await api.get(`repos/${params.repository}`);
    //   const issues = await api.get(`repos/${params.repository}/issues`);
    // }

    // async function loadData(): Promise<void> {
    // contorno um problema das requisições nao serem executadas ao mesmo tempo
    // posicao 0 repositories e posição 1 issues
